...
CAlarmClockDlg::CAlarmClockDlg(CWnd* pParent /*=nullptr*/)
	: CDialog(IDD_ALARMCLOCK_DIALOG, pParent)
{
...
BEGIN_MESSAGE_MAP(CAlarmClockDlg, CDialog)
	...
	ON_COMMAND(ID_32775, &CAlarmClockDlg::On32775)
END_MESSAGE_MAP()
...
void CAlarmClockDlg::On32776()
{
	...
	msgBox.hwndOwner = CAlarmClockDlg::GetSafeHwnd();
